...
[CreateAssetMenu(fileName = "Sweeping", menuName = "CardEffects/Sweeping")]
public class Sweeping : CardEffect
{
    ...
    public override void Execute(GameObject player, GameObject enemy, CardData cardData)
    {
        ...
        foreach (Enemy activeEnemy in BattleManager.Instance.ActiveEnemiesGetter())
        {
